...
/**
 * @brief Note in the loop below there is a nested while(1) loop, this was done because i was originally doing a 
 * dual core setup and copied the code from a loop to this. Needless to say you can delete the while loop since
 * loop already does this.... 
 * 
 */
void loop()
{
